		...
		private static void ogListFiller()
			{
				...
				CarList.add(new Car(2459, 125, 125, 97, "red", 115, "Toyota", "Corolla", 2000, "C O R O L L A", 300000, 5000));
				CarList.add(new Car(3015, 160, 146, 104, "silver", 120, "Ford", "Focus", 2012, "Andrewmobile", 165000, 6000));
